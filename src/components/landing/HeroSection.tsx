      ...
      <div className="container relative z-10 px-4 py-20">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-[1.15] tracking-tight"
          >
            <motion.span
          ...
          >
            <Link to="/auth">
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
              >
                <Button size="lg" className="btn-primary-glow text-base px-7 py-5 rounded-full group">
                  Start Learning Free
                  <motion.span
                    className="ml-2"
                    animate={{ x: [0, 4, 0] }}
          ...
          >
            {[
              ...
              >
                <motion.div 
                  className={`text-2xl md:text-3xl font-bold ${stat.gradient} mb-1`}
                  whileHover={{ scale: 1.1 }}
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  {stat.value}
                </motion.div>
                <div className="text-muted-foreground text-xs md:text-sm group-hover:text-foreground transition-colors">
                  {stat.label}
                </div>
              </motion.div>
            ))}
